...
{
    /// <summary>
    /// Day D's morning check-in: writes values to their owning days, records deferrals,
    /// locks the denominator, closes D-1 (spec §7).
    /// </summary>
    ...
    /// <summary>Edits on open days + filling deferred fields (date = the value's owning day).</summary>
    ...
    // ---- Quick tasks (spec §6 tasks — M2 pulled forward) ----
